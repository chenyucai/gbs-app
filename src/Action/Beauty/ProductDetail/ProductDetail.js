      ...
      <View style={styles.wrapper}>
        ...
        <ScrollView>
          ...
          <View style={styles.recommend_wrapper}>
            ...
            <View style={styles.recommend_footer}>
              <View style={styles.recommend_left}><Image source={require('../assets/line_left.png')}/></View>
              <Text style={styles.recommend_title}>224人推荐这个服务</Text>
              <View style={styles.recommend_right}><Image source={require('../assets/line_right.png')}/></View>
            </View>
          </View>
        ...
        <View style={styles.cart_wrapper}>
          <View style={styles.cart_goods}>
            {/* 此处少了一个购物车的图标 */}
            <Image source={require('../assets/icon_dis_Cart.png')}/>
          </View>
