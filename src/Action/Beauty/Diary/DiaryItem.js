    ...
    return(
      <View style={styles.diary_wrapper}>
        ...
        <View style={styles.diary_content}>
          <Image style={styles.diary_content_img} source={require('../assets/g.jpg')} />
          <Image style={styles.diary_content_img} source={require('../assets/g.jpg')} />
          <Image style={styles.diary_content_img} source={require('../assets/g.jpg')} />
        </View>
        <View style={styles.diary_footer}>
          <View style={styles.diary_footer_left}>
            <Image style={styles.diary_footer_left_img} source={require('../assets/icon_see.png')}/>
            <Text style={styles.diary_footer_left_text}>234</Text>
          </View>
          <View style={[styles.diary_footer_left,styles.diary_footer_left_ts]}>
            <Image style={styles.diary_footer_left_img} source={require('../assets/icon_Fabulous.png')}/>
            <Text style={styles.diary_footer_left_text}>999+</Text>
          </View>
          <View style={[styles.diary_footer_left,styles.diary_footer_left_ts]}>
            <Image style={styles.diary_footer_left_img} source={require('../assets/icon_message.png')}/>
            <Text style={styles.diary_footer_left_text}>234</Text>
          </View>
