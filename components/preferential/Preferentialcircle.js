...
import TopNacComponent from '../common/TopNav'
import PreferentialcircleModulesComponent from './PreferentialcircleModules'
  ...
  render () {
    ...
    return (
      <View style={styles.wrapper}>
        <TopNacComponent title="特惠圈" navigator={this.props.navigator}/>
        <ScrollView>
          <View>
          ...
          <PreferentialcircleModulesComponent navigator={this.props.navigator}/>
